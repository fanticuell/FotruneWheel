...
namespace FotruneWheel.Classes
{
    public class Connection
    {
        ...
        {
            currentShares.Clear();
            string str = "select sheetNumber, count(sheetNumber) as count from shares group by sheetNumber";
            var sqlite = QueryLite(str);
            while (sqlite.Read())
            {
        ...
        {
            string str = "INSERT INTO `winners` (`sheetNumber`,`fio`,`post`,`departament`,`prize`,`prizeGroup`,`winShare`,`number`) values ('" + winners.sheetNumber + "','" + winners.surname + "','" + winners.post + "','" + winners.departament + "','" + winners.prize + "','" + winners.prizeID + "','" + winners.winShare+ "','" + winners.number + "');";
            var sqlite = QueryLite(str);
            sqlite.Close();
